...
const AhmadBot = {
    ahmadhost: {
        ...
        ip: '51.142.86.236',
        grup: ['120363041980792908@g.us']
    },
    contoh: {
        nama: 'PRIBADI ADON',
        cloudflare: {
            listdomain: { '1': '.ahmad.systems', '2': '.xvideosx.xyz', '3': '.ph.com'},
            zona: { '1': 'isi zoneid', '2': '7b7453ebd1c3b72c171a2e346c6c9dd8', '3': 'isi zoneid'},
            tersedia: ['1'],
            data: {
                email: 'dewieleck@gmail.com',
...
module.exports = kurr = async (kurr, mek) => {
    try {
        ...
        const reply = (teks) => {
            kurr.sendMessage(from, teks, text, { thumbnail: dfrply, sendEphemeral: true, quoted: mek, contextInfo: { forwardingScore: 508, isForwarded: true, externalAdreply: { title: `${jmn} - ${week}  - ${calender}`, body: "KurrXdゑ v.3.0", previewType: "PHOTO", thumbnail: ofrply, sourceUrl: `https://wa.me/p/6285768515086/6283137619108` } } })
        }
        // GAME 
